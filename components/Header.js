    ...
    return (
        <div className="shadow-sm borderb-b bg-white sticky top-0 z-50 ">
            <div className="flex justify-between items-center bg-white max-w-6xl mx-5 lg:mx-auto">
                {/* Left */}
                <div className="relative hidden md:inline-grid h-24 w-24 cursor-pointer">
                    <Image src="https://links.papareact.com/ocw" layout="fill" objectFit="contain" />
                </div>
                <div className="relative md:hidden h-10 w-10 flex-shrink-0 cursor-pointer">
                ...
                <div className="flex items-center justify-end space-x-4">
                    ...
                    <img src="https://links.papareact.com/jjm" className="rounded-full h-6 w-6 cursor-pointer" />
                </div>
